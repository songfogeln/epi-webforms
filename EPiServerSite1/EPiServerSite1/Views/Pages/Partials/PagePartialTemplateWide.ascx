<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="PagePartialTemplateWide.ascx.cs" Inherits="EPiServerSite1.Views.Pages.Partials.PagePartialTemplateWide" %>
