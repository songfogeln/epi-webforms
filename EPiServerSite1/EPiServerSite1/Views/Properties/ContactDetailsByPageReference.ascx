<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContactDetailsByPageReference.ascx.cs" Inherits="EPiServerSite1.Views.Properties.ContactDetailsByPageReference" %>
