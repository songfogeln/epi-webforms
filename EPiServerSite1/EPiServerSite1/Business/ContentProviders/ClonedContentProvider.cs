...
namespace EPiServerSite1.Business.ContentProviders
{
    ...
    public class ClonedContentProvider : ContentProvider, IPageCriteriaQueryService
    {
        ...
        private PageData ClonePage(PageData originalPage)
        {
            ...
            _logger.Debug("Cloning page {0}...", originalPage.PageLink);
        ...
        public PageDataCollection FindAllPagesWithCriteria(PageReference pageLink, PropertyCriteriaCollection criterias, string languageBranch, ILanguageSelector selector)
        {
            ...
            var pages = DataFactory.Instance.FindAllPagesWithCriteria(pageLink, criterias, languageBranch, selector);
        ...
        /// </summary>
        protected virtual ContentStore ContentStore { get; set; }

        /// <summary>
        /// Content that should be cloned at the entry point
        /// </summary>
        public virtual PageReference CloneRoot { get; protected set; }

        /// <summary>
        /// Gets the page where the cloned content will appear
        /// </summary>
        public virtual PageReference EntryRoot { get; protected set; }
        ...
        public virtual CategoryList Category { get; protected set; }
